...
git clone https://github.com/tomaszbabiuk/aeplugin-emailaction.git
```
...
```
After running the server, go to http://localhost/plugins/objects and enable "Email action" plugin
...
Before lunch:
 - run gradle task: aeplugin-emailaction:buildForAutomateEverything
